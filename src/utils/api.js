const tmdb = {
  ...
  discoverMovies: function(year) {
    const discover = `${this.api_url}/discover/movie?primary_release_year=${year}&page=1&include_video=false&include_adult=false&sort_by=popularity.desc&language=en-UK&api_key=${this.api_key}`
